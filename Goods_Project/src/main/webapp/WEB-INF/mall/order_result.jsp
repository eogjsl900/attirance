				...
				<form id="frm_order_result" name="frm_order_result">
					<div class="xans-element- xans-order xans-order-result xans-record-">
						...
						<div class="orderInfo">
						        ...
						        <ul>
									<li>주문번호 : <strong>${order.onum }</strong>
									</li>
						            <li>주문일자 : <span>${order.orderdate }</span>
									</li>
						        </ul>
						</div>
					        ...
					        <div class="ec-base-table">
								...
								<tbody>
									<tr>
					                    ...
					                    <td>
					                        <strong class="txtEm txt18">${order.totalprice }</strong><strong class="txtEm">원</strong> <span class="txtEm displaynone"></span>
					                    </td>
					                </tr>
									<tr>
					                    ...
					                    <td>
					                        <strong><span>
					                        	<c:if test="${order.payment == 'inicis'}" >카드 결제</c:if>
					                        	<c:if test="${order.payment == 'danal' }" >핸드폰 결제</c:if>
					                        	<c:if test="${order.payment == 'kakaopay' }" >카카오 결제</c:if>
					                        	
					                        	</span></strong>
					                        <p>
					                            <span>계좌번호 : 신한은행 63790128739003<br><b>2019년 10월 2일(수)</b>까지 미입금시 주문이 자동취소됩니다.</span>
					                        </p>
					                        <p class="">
					                            	현금영수증 발행 :
								...
								<caption>기본배송</caption>
									...
									<tfoot class="right">
										...
										<td colspan="7">
											...
											+ 배송비 
											<c:if test="${order.totalprice < 30000}" >
											...
											<span class="displaynone"> - 상품할인금액 0</span>
											 ...
											 <strong class="txtEm gIndent10">
											 	<span class="txt18">${order.totalprice}</span>원
											 </strong> 
										</td>
					                    </tr>
					                </tfoot>
					                	...
					                	<tr class="xans-record-">
											<td class="thumb">
												<a href="/product/detail.html?product_no=735&amp;cate_no=1">
													<img src="${pageContext.request.contextPath}/resources/prd_image/${lists.pimage}" onerror="this.src='//img.echosting.cafe24.com/thumb/img_product_small.gif';" alt="">
												</a>
											</td>
					                        <td class="left">
					                            <a href="/product/detail.html?product_no=735&amp;cate_no=1">
					                            	<strong>${lists.pname }</strong>
					                            </a>
					                            <div class="option ">
					                        ...
					                        <td class="right">
					                            ...
					                            <div class="displaynone">
					                                <strong>${lists.qty }</strong>
					                            </div>
					                        </td>
					                        <td>1</td>
					                        <td><span class="txtInfo">${lists.point }</span></td>
					                        <td>
					                        	<div class="txtInfo">
					                        		기본배송
												</div>
					                        ...
					                        <td class="right">
												<strong>${lists.amount }</strong><div class="displaynone"></div>
											</td>
					                    </tr>
									</c:forEach>
									</tbody>
									...
									<tbody class="center">
										<tr>
											<td class="price2">
												<div class="box txt16">
													<strong>
														<span class="txt23">${order.totalprice }</span>원
													</strong>
												</div>
											</td>
						                    <td>
				        ...
				        <div class="ec-base-table">
				            ...
				            <colgroup>
								...
								<tbody>
									...
									<tr class="">
									<th scope="row">주소</th>
									                    <td><span>${order.addr1 }&nbsp;${order.addr2 }</span></td>
									                </tr>
									...
									<th scope="row">휴대전화</th>
									                    <td><span>${order.phone1}-${order.phone2}-${order.phone3}</span></td>
									                </tr>
									<tr>
