...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/coupon/coupon3.css">        
            ...
            <div id="smart_wrap">
                <div id="baner_wrap" class="sk_color01">
                    <div class="skb_topimg">
                        <img src="${pageContext.request.contextPath}/resources/coupon/sk_top_main.png" usemap="#Map_coupon" border="0">
